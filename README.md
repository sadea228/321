...
В продакшене запустите скрипт как фоновый процесс и обеспечьте автоматический перезапуск через systemd, pm2, supervisord или другой менеджер процессов.
...
- Применяется асинхронный подход с async/await
